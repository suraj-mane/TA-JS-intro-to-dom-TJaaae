...
//document.querySelectorAll('hr').style.border = "1px solid tomato";
// Change the background of all the hr to "antiquewhite" using for of loop.
for (const allhr of allHrs) {
  allhr.style.backgroundcolor="antiquewhite";
}
// Change the 'border-radius' of all the hr to "5px" using array.
//allHrsArray.style.border="5px"; 
...
//document.querySelectorAll('hr').style.border = "2px dashed purple";
...
let imgElm = document.createElement("img").src = "https://images.unsplash.com/photo-1592500595497-d1f52a40b207?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=400&q=80";
...
document.querySelectorAll('input').placeholder = "Enter you email";
// Append the input element to the box 5 you selected above
box[4].append("Enter you email");
